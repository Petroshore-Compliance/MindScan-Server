...
-- CreateIndex
CREATE UNIQUE INDEX "UserResponses_user_id_company_id_key" ON "UserResponses"("user_id", "company_id");

-- CreateIndex
CREATE UNIQUE INDEX "PetroAdmin_email_key" ON "PetroAdmin"("email");

-- CreateIndex
CREATE UNIQUE INDEX "Result_user_id_company_id_key" ON "Result"("user_id", "company_id");
...
-- AddForeignKey
ALTER TABLE "UserResponses" ADD CONSTRAINT "UserResponses_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "Company"("company_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "Company"("company_id") ON DELETE RESTRICT ON UPDATE CASCADE;
