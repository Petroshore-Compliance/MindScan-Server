...
} = require("../middlewares/adminMiddlewares/updateAdminMiddleware.js");
const {
  deleteAdminMiddleware,
} = require("../middlewares/adminMiddlewares/deleteAdminMiddleware.js");
const {
  createAdminMiddleware,
} = require("../middlewares/adminMiddlewares/createAdminMiddleware.js");
const { loginAdminMiddleware } = require("../middlewares/adminMiddlewares/loginAdminMiddleware.js");
const {
  forgotPasswordAdminMiddleware,
} = require("../middlewares/adminMiddlewares/forgotPasswordAdminMiddleware.js");
const {
  setPasswordAdminMiddleware,
} = require("../middlewares/adminMiddlewares/setPasswordAdminMiddleware.js");
const {
  changePasswordAdminMiddleware,
} = require("../middlewares/adminMiddlewares/changePasswordAdminMiddleware.js");
const {
  getCompaniesMiddleware,
} = require("../middlewares/adminMiddlewares/getCompaniesMiddleware.js");
const {
  addLicensesMiddleware,
} = require("../middlewares/adminMiddlewares/addLicensesMiddleware.js");
const { getUsersMiddleware } = require("../middlewares/adminMiddlewares/getUsersMiddleware.js");
...
} = require("../handlers/adminHandlers/forgotPasswordAdminHandler.js");
const { setPasswordAdminHandler } = require("../handlers/adminHandlers/setPasswordAdminHandler.js");
const {
  changePasswordAdminHandler,
} = require("../handlers/adminHandlers/changePasswordAdminHandler.js");
...
const { getUsersHandler } = require("../handlers/adminHandlers/getUsersHandler.js");
...
router.get("/get-users", adminMiddleware, getUsersMiddleware, getUsersHandler);
