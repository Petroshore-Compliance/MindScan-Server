...
const emailChangeCompanySenderScript = async (id_to_link, emailToVerify, htmlPath,companyName,verificationToken) => {
...
let htmlTemplate;
  ...
  const htmlContent3 = htmlTemplate.replace(/{{changeCompanyURL}}/g, "localhost:400/pestañaDondePonerElToken");
