...
const emailCreateNewUserScript = async (emailToVerify, htmlPath,companyName,verificationToken) => {
...
let htmlTemplate;
  ...
  const htmlContent3 = htmlTemplate.replace(/{{joinCompanyURL}}/g, "localhost:400/pestañaDonderegistrarse");
