...
describe('admin Endpoints', () => {
  it('success adding licenses; status 200', async () => {
    ...
    expect(response.body).toEqual({ "message": "10licenses added successfully to a total of 10 licenses." });
...
describe('admin Endpoints', () => {
  it('success adding licenses, again; status 200', async () => {
    ...
    expect(response.body).toEqual({ "message": "346licenses added successfully to a total of 356 licenses." });
    expect(response.status).toBe(200);
