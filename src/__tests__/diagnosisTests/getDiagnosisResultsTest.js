...
describe("Auth Endpoints", () => {
  it("success getDiagnosisResult;status 200 ", async () => {
    ...
    expect(response.body.diagnosisResult).toEqual([{ "actions": 3, "activity": 3, "aesthetic_appreciation": 3, "agreeableness_or_amiability": 3, "altruism": 3, "anxiety": 3, "assertiveness": 3, "competence": 3, "conciliatory_attitude": 3, "cordiality": 3, "deliberation": 3, "depression": 3, "excitement_seeking": 3, "extraversion": 3, "fantasy": 3, "feelings": 3, "frankness": 3, "gregariousness": 3, "hostility": 3, "ideas": 3, "impulsivity": 3, "modesty": 3, "need_for_achievement": 3, "neuroticism_x_emotional_stability": 3, "openness_to_experience": 3, "orderliness": 3, "perseverance_or_responsibility": 3, "positive_emotions": 3, "self_discipline": 3, "sense_of_duty": 3, "sensitivity_to_others": 3, "social_anxiety": 3, "trust": 3, "values": 3, "vulnerability": 3 }]);
